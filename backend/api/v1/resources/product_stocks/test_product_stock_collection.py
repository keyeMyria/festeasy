...
class TestProductStockCollection(APITestCase):
    def test_get(self):
        ...
        self.assertEqual(repsonse.json[0]['id'], product_stock.id)
    ...
    def test_post(self):
        ...
        self.assertIsNotNone(fetched_product_stock)
        self.assertEqual(fetched_product_stock.product_id, product.id)
